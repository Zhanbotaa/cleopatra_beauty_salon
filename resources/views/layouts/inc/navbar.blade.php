  ...
  <div class="collapse navbar-collapse " id="navbarText">
    ...
    <ul class="navbar-nav mx-auto text-center ">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="{{url('/contact-us')}}">Фото наших работ</a>
      </li>

    </ul>

    <a class="navbar-text " href="{{url('/adminn')}}" style="font-family:'Playfair Display';font-size: 18px; position:absolute;right:150px; ">
      Admin 
    </a>
